...
<button type='submit' name='next' style='width:120px;height:50px;background-color: #4CAF50; color: #900;border: 1px solid #900;  font-weight: bold;'>Add Question</button>
 ...
 <td colspan="2">
<button type='submit' href="teacher.php" name='next' style='width:120px;height:50px;background-color: #4CAF50; color: #900;border: 1px solid #900;  font-weight: bold;'>Save Quiz</button>
